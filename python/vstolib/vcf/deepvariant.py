...
"""
The purpose of this python3 script is to implement a parser for DeepVariant VCF files.
"""
...
def parse_deepvariant_callset(
    ...
    for row in df_vcf.to_dict('records'):
        for sample_id in sample_ids:
            ...
            if 'VAF' in attributes.keys():
                if attributes['VAF'] == '':
                    alternate_allele_fraction = -1.0
                else:
                    alternate_allele_fraction = float(attributes['VAF'])
