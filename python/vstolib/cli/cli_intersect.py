...
def add_cli_intersect_arg_parser(
        sub_parsers: argparse._SubParsersAction
) -> argparse._SubParsersAction:
    """
    Adds 'intersect' parser.
    """
    parser = sub_parsers.add_parser(
        'intersect',
        help='Intersect variants. '
...
def run_cli_intersect_from_parsed_args(args: argparse.Namespace):
    """
    Run 'intersect' command using parameters from parsed arguments.
    ...
    # Step 2. Intersect variants lists
    logger.info("Started intersecting all variants")
